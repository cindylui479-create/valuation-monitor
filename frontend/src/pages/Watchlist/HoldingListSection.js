    ...
    return (_jsxs("div", { children: [_jsxs("section", { className: "latest-card", style: { marginBottom: 16 }, children: [weightedTemp != null && (_jsx("div", { className: "tier-pill", style: { backgroundColor: temperatureColor(weightedTemp.toString()) }, children: "\u7EC4\u5408\u6E29\u5EA6" })), _jsxs("div", { className: "stat", children: [_jsx("div", { className: "label", children: "\u603B\u5E02\u503C" }), _jsxs("div", { className: "value", children: ["\u00A5", total.toLocaleString("zh-CN", { maximumFractionDigits: 0 })] })] }), _jsxs("div", { className: "stat", children: [_jsx("div", { className: "label", children: "\u52A0\u6743\u6E29\u5EA6\uFF08\u6309\u5E02\u503C\uFF09" }), _jsx("div", { className: "value", children: weightedTemp != null ? weightedTemp.toFixed(1) : "—" })] }), _jsxs("div", { className: "stat", children: [_jsx("div", { className: "label", children: "\u6E29\u5EA6\u8986\u76D6\u7387" }), _jsxs("div", { className: "value", children: [coverage.toFixed(0), "%"] })] }), _jsxs("div", { className: "stat", children: [_jsx("div", { className: "label", children: "\u6301\u4ED3\u9879" }), _jsx("div", { className: "value", children: data.items.length })] }), hasCostData && (_jsxs(_Fragment, { children: [_jsxs("div", { className: "stat", children: [_jsx("div", { className: "label", children: "\u603B\u6210\u672C" }), _jsxs("div", { className: "value", children: ["\u00A5", totalCost.toLocaleString("zh-CN", { maximumFractionDigits: 0 })] })] }), _jsxs("div", { className: "stat", children: [_jsx("div", { className: "label", children: "\u672A\u5B9E\u73B0\u76C8\u4E8F" }), _jsxs("div", { className: "value", style: { color: pnlColor(totalPnl) }, children: [totalPnl > 0 ? "+" : "", "\u00A5", totalPnl.toLocaleString("zh-CN", { maximumFractionDigits: 0 })] })] }), totalPnlPct != null && (_jsxs("div", { className: "stat", children: [_jsx("div", { className: "label", children: "\u76C8\u4E8F\u6BD4\u4F8B" }), _jsxs("div", { className: "value", style: { color: pnlColor(totalPnlPct) }, children: [totalPnlPct > 0 ? "+" : "", totalPnlPct.toFixed(2), "%"] })] }))] }))] }), Object.keys(data.tier_distribution).length > 0 && (_jsxs("section", { className: "settings-block", children: [_jsx("h3", { children: "\u6863\u4F4D\u5206\u5E03\uFF08\u6309\u5E02\u503C\u5360\u6BD4\uFF09" }), _jsx("div", { style: { display: "flex", height: 32, borderRadius: 4, overflow: "hidden", border: "1px solid #e5e7eb" }, children: TIER_ORDER.map((tier) => {
                            ...
                            return (_jsx("div", { title: `${tier} ${pct.toFixed(1)}%`, style: {
                                    ...
                                    display: "flex", alignItems: "center", justifyContent: "center",
                                        ...
                                        }, children: "\u6309\u6570\u91CF" })] }), _jsx("input", { placeholder: mode === "value" ? "市值（¥）" : "股数 / 份数", type: "number", value: amount, onChange: (e) => setAmount(e.target.value), style: { width: 140, padding: "4px 8px" } }), _jsx("input", { placeholder: "\u6210\u672C\uFF08\u00A5\uFF0C\u53EF\u9009\uFF0C\u7528\u4E8E\u76C8\u4E8F\uFF09", type: "number", value: costBasis, onChange: (e) => setCostBasis(e.target.value), style: { width: 180, padding: "4px 8px" }, title: "\u5F55\u5165\u6301\u4ED3\u7684\u603B\u6210\u672C\uFF08\u4EBA\u6C11\u5E01\uFF09\u3002\u540E\u7EED\u6309\u5F53\u524D\u5E02\u503C\u7B97\u672A\u5B9E\u73B0\u76C8\u4E8F\u3002" }), _jsx("input", { placeholder: "\u5907\u6CE8\uFF08\u53EF\u9009\uFF09", value: note, onChange: (e) => setNote(e.target.value), style: { width: 140, padding: "4px 8px" } }), _jsx("button", { className: "btn btn-primary", disabled: !selected || !amount || addMut.isPending, onClick: () => addMut.mutate(), children: addMut.isPending ? "..." : "加入" })] }), err && _jsx("p", { style: { color: "#b91c1c", fontSize: 12, marginTop: 8 }, children: err }), _jsx("p", { className: "hint", children: mode === "value"
                            ? "按金额：直接录入当前市值（人民币）。"
                            : "按数量：录入股数/份数，系统自动按最新价 × 数量算市值，并每 30 秒刷新一次。" })] }), _jsxs("section", { className: "settings-block", children: [_jsxs("h3", { children: ["\u6301\u4ED3\u660E\u7EC6\uFF08", data.items.length, "\uFF09"] }), data.items.length === 0 ? (_jsx("p", { className: "empty", children: "\u8FD8\u6CA1\u6709\u6301\u4ED3\u3002\u5728\u4E0A\u65B9\u5F55\u5165\u3002" })) : (_jsxs("table", { className: "table", children: [_jsx("thead", { children: _jsxs("tr", { children: [_jsx("th", { children: "\u7C7B\u578B" }), _jsx("th", { children: "\u4EE3\u7801" }), _jsx("th", { children: "\u540D\u79F0" }), _jsx("th", { children: "\u5F55\u5165" }), _jsx("th", { children: "\u5E02\u503C\uFF08\u00A5\uFF09" }), _jsx("th", { children: "\u6210\u672C\uFF08\u00A5\uFF09" }), _jsx("th", { children: "\u76C8\u4E8F" }), _jsx("th", { children: "\u6743\u91CD" }), _jsx("th", { children: "\u6E29\u5EA6" }), _jsx("th", { children: "\u6863\u4F4D" }), _jsx("th", { children: "PE / PB" }), _jsx("th", { children: "\u53E3\u5F84" }), _jsx("th", { children: "\u5907\u6CE8" }), _jsx("th", {})] }) }), _jsx("tbody", { children: data.items.map((h) => {
                                    ...
                                    return (_jsxs("tr", { children: [_jsx("td", { children: _jsx("span", { style: {
                                                    ...
                                                    : "金额" }), _jsx("td", { children: isEditing ? (_jsxs("div", { style: { display: "flex", gap: 4, alignItems: "center" }, children: [_jsxs("select", { value: editMode, onChange: (e) => setEditMode(e.target.value), style: { fontSize: 11, padding: "1px 4px" }, children: [_jsx("option", { value: "value", children: "\u00A5" }), _jsx("option", { value: "quantity", children: "\u6570\u91CF" })] }), _jsx("input", { type: "number", value: editAmount, onChange: (e) => setEditAmount(e.target.value), onKeyDown: (e) => {
                                                                ...
                                                                if (e.key === "Escape")
                                                                    setEditingId(null);
                                                            }, style: { width: 80, padding: "2px 4px", fontSize: 12 }, autoFocus: true })] })) : (parseFloat(h.market_value).toLocaleString("zh-CN", { maximumFractionDigits: 0 })) }), _jsx("td", { style: { fontSize: 12, color: "#6b7280" }, children: h.cost_basis
                                                    ? parseFloat(h.cost_basis).toLocaleString("zh-CN", { maximumFractionDigits: 0 })
                                                    : "—" }), _jsx("td", { style: { fontSize: 12 }, children: (() => {
                                                    if (!h.unrealized_pnl)
                                                        return "—";
                                                    const pnl = parseFloat(h.unrealized_pnl);
                                                    const pct = h.pnl_pct ? parseFloat(h.pnl_pct) : null;
                                                    return (_jsxs("span", { style: { color: pnlColor(pnl) }, children: [pnl > 0 ? "+" : "", pnl.toLocaleString("zh-CN", { maximumFractionDigits: 0 }), pct != null && (_jsxs("span", { style: { marginLeft: 4 }, children: ["(", pct > 0 ? "+" : "", pct.toFixed(1), "%)"] }))] }));
                                                })() }), _jsx("td", { children: h.weight_pct ? h.weight_pct + "%" : "—" }), _jsx("td", { children: temp != null ? (_jsxs(_Fragment, { children: [_jsx("span", { style: {
