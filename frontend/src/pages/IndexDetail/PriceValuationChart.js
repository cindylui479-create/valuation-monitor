...
export default function PriceValuationChart({ quotes, title }) {
    ...
    return _jsx(ReactECharts, { option: option, style: { height: 380, width: "100%" } });
}
