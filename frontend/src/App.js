...
export default function App() {
    return (_jsxs("div", { className: "app", children: [_jsx(Header, {}), _jsx("main", { className: "main", children: _jsxs(Routes, { children: [_jsx(Route, { path: "/", element: _jsx(Overview, {}) }), _jsx(Route, { path: "/indices/:code", element: _jsx(IndexDetail, {}) }), _jsx(Route, { path: "/stocks/:code", element: _jsx(StockDetail, {}) }), _jsx(Route, { path: "/funds/:code", element: _jsx(FundDetail, {}) }), _jsx(Route, { path: "/watchlist", element: _jsx(Watchlist, {}) }), _jsx(Route, { path: "/signals", element: _jsx(Signals, {}) }), _jsx(Route, { path: "/temperature/effectiveness", element: _jsx(TemperatureEffectiveness, {}) }), _jsx(Route, { path: "/dca", element: _jsx(DCA, {}) }), _jsx(Route, { path: "/backtest", element: _jsx(Backtest, {}) }), _jsx(Route, { path: "/settings", element: _jsx(Settings, {}) }), _jsx(Route, { path: "*", element: _jsx(Navigate, { to: "/", replace: true }) })] }) })] }));
}
